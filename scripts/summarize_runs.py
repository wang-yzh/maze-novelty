...
def main() -> None:
    ...
    for row in rows:
        print(
            ...
            row["test_score"],
            "primary=",
            row.get("primary_score", "n/a"),
            "diagnostic=",
            row.get("diagnostic_score", "n/a"),
            "coverage=",
            row["archive_coverage"],
            "subgoal=",
            row.get("subgoal_score", "n/a"),
            "regions=",
            row.get("new_region_count", "n/a"),
            "transitions=",
            row.get("region_transition_count", "n/a"),
            "unique=",
